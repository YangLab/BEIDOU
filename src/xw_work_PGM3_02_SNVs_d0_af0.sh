...
{
# gatk_d0_af0
${dir_of_perl}/perl ${join_ID_pl} <(bcftools view $filtering_dbSNP_vcf -H 2>/dev/null|awk 'BEGIN{OFS="\t"}{print $1":"$2,$1,$2,$3,$4}') ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_gatk_d0_af0.txt 1 4 |cut -f 1,4,7-9,13-18 > ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_gatk_d0_af0.txt
...
{
# lofreq_d0_af0
${dir_of_perl}/perl ${join_ID_pl} <(bcftools view $filtering_dbSNP_vcf -H 2>/dev/null |awk 'BEGIN{OFS="\t"}{print $1":"$2,$1,$2,$3,$4}') ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_lofreq_d0_af0.txt 1 4 |cut -f 1,4,7-9,13-18 > ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_lofreq_d0_af0.txt
...
{
# strelka2_d0_af0
${dir_of_perl}/perl ${join_ID_pl} <(bcftools view $filtering_dbSNP_vcf -H 2>/dev/null|awk 'BEGIN{OFS="\t"}{print $1":"$2,$1,$2,$3,$4}') ${work_path}/Novel_SNVs_d0_af0/${name}_12_SNVs_strelka2_d0_af0.txt 1 4 |cut -f 1,4,7-9,13-18 > ${work_path}/Novel_SNVs_d0_af0/${name}_13_all_strelka2_d0_af0.txt
