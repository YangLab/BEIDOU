...
step7_HaplotypeCaller(){
    ...
    java -jar ${dir_of_picard}/picard.jar MergeVcfs \
          ...
          O=$hap_out
    test -s $hap_out && rm -r ${work_path}/hap_split_chr 
